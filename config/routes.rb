...
#                                          POST       /api/v1/clippings/:clipping_id/report(.:format)                                                   api/v1/clippings/reports#create {format: :json}
  ...
  namespace :api do
    namespace :v1, defaults: { format: :json } do
      ...
      resources :clippings, only: %i[index show create update destroy] do
        resource :report, only: %i[create show update], module: :clippings do
