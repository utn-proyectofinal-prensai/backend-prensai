module Clippings
  ...
  class ReportPdfExporter
    ...
    def content_section(markdown_html)
      <<~HTML
        <div class="content">
          #{markdown_html}
        </div>
    ...
    def date_range_text
      start_date = formatted_date(report.clipping.start_date)
      end_date = formatted_date(report.clipping.end_date)

      return "#{start_date} - #{end_date}" if start_date && end_date
      return "Desde #{start_date}" if start_date
      return "Hasta #{end_date}" if end_date
